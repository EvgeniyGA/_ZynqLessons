...
-- Date        : Thu May  4 18:17:17 2023
-- Host        : Laptop running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Projects/_Zynq/_ZynqLessons/Petalinux/1_helloWorld/1_helloWorld.srcs/sources_1/bd/main/ip/main_processing_system7_0_0/main_processing_system7_0_0_sim_netlist.vhdl
...
entity main_processing_system7_0_0_processing_system7_v5_5_processing_system7 is
  ...
  attribute C_FCLK_CLK0_BUF of main_processing_system7_0_0_processing_system7_v5_5_processing_system7 : entity is "FALSE";
  ...
  attribute C_USE_M_AXI_GP0 of main_processing_system7_0_0_processing_system7_v5_5_processing_system7 : entity is 0;
  ...
  attribute POWER of main_processing_system7_0_0_processing_system7_v5_5_processing_system7 : entity is "<PROCESSOR name={system} numA9Cores={2} clockFreq={766} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={16} clockFreq={533} readRate={0.5} writeRate={0.5} /><IO interface={UART} ioStandard={LVCMOS18} bidis={2} ioBank={Vcco_p1} clockFreq={100.000000} usageRate={0.5} /><IO interface={SD} ioStandard={LVCMOS18} bidis={6} ioBank={Vcco_p1} clockFreq={100.000000} usageRate={0.5} /><IO interface={GigE} ioStandard={LVCMOS18} bidis={14} ioBank={Vcco_p1} clockFreq={125.000000} usageRate={0.5} /><IO interface={QSPI} ioStandard={LVCMOS33} bidis={6} ioBank={Vcco_p0} clockFreq={200} usageRate={0.5} /><PLL domain={Processor} vco={1533.333} /><PLL domain={Memory} vco={1066.667} /><PLL domain={IO} vco={1000.000} />/>";
